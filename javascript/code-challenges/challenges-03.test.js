...
const typeNum = (arr) => {
  const newArr = arr.filter(arrItem => typeof arrItem === typeof 0);
  return newArr;
};
...
const containsAnd = (arr) => {
  const newArr = arr.filter(arrItem => arrItem.includes('and'));
  return newArr;
};
...
const oddValues = (arr) => {
  const newArr = arr.filter(arrItem => !(arrItem % 2 === 0));
  return newArr;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  const newArr = arr.filter(arrItem => !forbiddenValues.includes(arrItem));
  return newArr;
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  const newArr = arr.filter(arrItem => arrItem.baseStat > minBaseStat);
  return newArr;
};
...
const getStatName = (arr, minBaseStat) => {
  const objArr = arr.filter(arrItem => arrItem.baseStat > minBaseStat);
  const nameArr = objArr.map((objItem)=> objItem.stat.name);
  return nameArr;
};
...
const getCharactersWithoutChildren = (arr) => {
  const newArr = arr.filter(obj => !(obj.children));
  return newArr;
};
...
const evenOddNumericValues = (arr) => {
  const filteredArr = arr.filter(arrItem => typeof arrItem === typeof 0);
  const evenOddArr = filteredArr.map(filteredItem => (filteredItem%2 === 0) ? 'even' : 'odd');
  return evenOddArr;
};
