...
const getNames = (arr) => {
  const newArr = arr.map(arrItem => arrItem.name.split('').reverse().join('')); //just learned that you can couple methods like by looking at how someone used reverse online.
  return newArr;
};
